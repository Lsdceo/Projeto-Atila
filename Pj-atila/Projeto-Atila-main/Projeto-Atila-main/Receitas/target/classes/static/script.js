...
document.getElementById('recipe-form').addEventListener('submit', async function(event) {
    ...
    const recipe = document.getElementById('recipe-name').value;
    ...
    try {
        ...
        const response = await fetch('pj-atila-c4c3gkhadygheghs.brazilsouth-01.azurewebsites.net/recipes', requestOptions);
